<img src="https://github.com/CU-ESIIL/HYR-SENSE/blob/main/docs/assets/hyrsense_facilitators/Ayia_Lindquist.jpg" alt="Ayia Lindquist" width= 2.5in height= 2.5in float= left margin-right= 10px />
